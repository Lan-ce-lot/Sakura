	...
	class Silence {
		...
		buildBloggerProfile() {
			...
			var title = '<div class="site-branding">' +
					...
					'<a href="https://www.cnblogs.com/lanclot-/" alt="Lance">' +
					'<ruby><span class="sakuraso">Lance</span><span class="shironeko">lot</span>' +
					'<rt class="chinese-font">Lance</rt></ruby></a></span>' +
					'</div>'
